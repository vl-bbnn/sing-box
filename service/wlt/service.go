...
func (s *Service) Close() error {
	...
	s.logger.Info("wlt service stopped active=", stats.ActiveStreams, " peak_active=", stats.PeakActiveStreams, " pending=", stats.PendingDials, " peak_pending=", stats.PeakPendingDials, " opened=", stats.OpenedStreams, " closed=", stats.ClosedStreams, " queued=", stats.QueuedDials, " rejected=", stats.RejectedStreams, " rejected_queue=", stats.RejectedQueue, " rejected_active=", stats.RejectedActive, " rejected_open=", stats.RejectedOpen, " failed=", stats.FailedStreams, " max_dial_ms=", stats.MaxDialMillis, " reconnect_retries=", stats.ReconnectRetries, " reconnect_wait_ms=", stats.ReconnectWaitMillis, " reconnects=", stats.Runtime.FullReconnects, " last_reconnect=", stats.Runtime.LastReconnectReason, " peer_next_seq=", peer.NextReadSequence, " peer_highest_seq=", peer.HighestReadSequence, " peer_reorder_pending=", peer.ReorderPending, " peer_reorder_pending_bytes=", peer.ReorderPendingBytes, " peer_history_packets=", peer.HistoryPackets, " peer_history_bytes=", peer.HistoryBytes, " peer_nack_sent=", peer.NACKRequestsSent, " peer_nack_received=", peer.NACKRequestsRecv, " peer_retransmit_packets=", peer.RetransmitPackets, " peer_retransmit_copies=", peer.RetransmitCopies, " peer_retransmit_misses=", peer.RetransmitMisses, " peer_ack_sent=", peer.ACKFramesSent, " peer_ack_received=", peer.ACKFramesRecv, " peer_ack_invalid=", peer.ACKInvalid, " peer_last_acked_seq=", peer.LastAckedSequence, " peer_window_waits=", peer.WindowWaits, " peer_window_wait_ms=", peer.WindowWaitNanos/int64(time.Millisecond))
	return err
}
