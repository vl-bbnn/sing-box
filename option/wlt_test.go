...
func TestWLTConfigUnmarshalAcceptsServiceAndOutbound(t *testing.T) {
		...
		"services": [
			{
				...
				"transport": "wlt",
				"carrier_config": "{}",
				"auth_snapshot": "active-bootstrap",
				"auth_reserve_snapshot": "reserve-bootstrap",
	...
	if serviceOptions.AuthSnapshot != "active-bootstrap" || serviceOptions.AuthReserveSnapshot != "reserve-bootstrap" {
		t.Fatalf("auth ring bootstrap options=%+v", serviceOptions)
	}
